...
@Schema(description = "todo를 부분 update할 때 사용합니다. 일반 TodoRequest랑은 다른점은 todo가 required 하지 않습니다.")
...
fun TodoPatchRequest.toPatchRequest() = TodoUpdateServiceRequestDTO(
    todo = todo,
    isDone = isDone,
